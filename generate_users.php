...
for (; $x<=$m; $x++)
  {  $flag2=0;
     ...
     echo 'username: '.$batch.$x.'<br>password: '.$new.'<br>Please fill in all your profile details after logging in and change your password<br><br><br>';
     //echo $message;
     $roll = $batch.$x ;
   ...
   if($x==$m  &&  $flagin==1 && $j<$inl){
    ...
    $message = "Please Login with your Roll .Update Your Profile as well.";
     ...
     $newhash=hash('sha256',$new);
     $message .= "\n new password is \" $new \". change this password after first login.";
     echo 'username: '.$x.'<br>password: '.$new.'<br>Please fill in all your profile details after logging in and change your password<br><br><br>';
     //echo $message;
     $roll = $x ;
     $insert_sql =  "INSERT INTO alumni (username,password)
     VALUES ('$roll','$newhash')"; 
